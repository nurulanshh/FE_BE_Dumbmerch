...
exports.addTransaction = async (req, res) => {
  try {
    ...
    let snap = new midtransClient.Snap({
      isProduction: false,
      serverKey: 'SB-Mid-server-T_zhefxFtCMJuLT8F3irD7Zw',
    });
...
const MIDTRANS_SERVER_KEY = 'SB-Mid-server-T_zhefxFtCMJuLT8F3irD7Zw'
const MIDTRANS_CLIENT_KEY = 'SB-Mid-client-_uTSrD57ODPvAE-B'
